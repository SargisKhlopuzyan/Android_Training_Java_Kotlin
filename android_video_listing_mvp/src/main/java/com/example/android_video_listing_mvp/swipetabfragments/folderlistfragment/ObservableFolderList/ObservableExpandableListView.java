package com.example.android_video_listing_mvp.swipetabfragments.folderlistfragment.ObservableFolderList;
...
public class ObservableExpandableListView extends ExpandableListView implements Scrollable {
    ...
    public ObservableExpandableListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
