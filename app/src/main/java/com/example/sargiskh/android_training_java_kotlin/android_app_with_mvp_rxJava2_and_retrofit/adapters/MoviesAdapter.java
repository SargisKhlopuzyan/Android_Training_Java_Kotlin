package com.example.sargiskh.android_training_java_kotlin.android_app_with_mvp_rxJava2_and_retrofit.adapters;
...
import com.example.sargiskh.android_training_java_kotlin.android_app_with_mvp_rxJava2_and_retrofit.models.Result;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MoviesHolder> {
    ...
    public MoviesHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.movify_row_movies,parent,false);
